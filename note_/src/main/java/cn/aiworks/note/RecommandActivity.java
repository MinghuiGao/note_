...
public class RecommandActivity extends Activity implements OnClickListener,
    ...
    Handler handler = new RecommandHandler(this);

    private static class RecommandHandler extends Handler {
        private WeakReference<RecommandActivity> mAct;

        RecommandHandler(RecommandActivity act) {
            this.mAct = new WeakReference<RecommandActivity>(act);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Constant.DOWNLOAD_FAILED:
                    ...
                    pt.showMessage(mAct.get(), (String) msg.obj, msg.arg1, null);
                    break;
                default:
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleRecommandAdapter ma = new SimpleRecommandAdapter();
    ...
    private class SimpleRecommandAdapter extends BaseAdapter {
